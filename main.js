...
// получаем инпуты и кнопки для добавления данных
...
// тег для отобржения данных в браузере
...
btnAdd.addEventListener("click", ()=>{
    ...
    if(!inpDetails.value.trim()||!inpCategory.value.trim()||!inpPrice.value.trim()||!inpQuantity.value.trim()||!inpUrl.value.trim()||!inpSales.value.trim()){
...
async function readProducts(){
    ...
    data.forEach((item) => {
        ...
        <img src="https://cdn-icons-png.flaticon.com/512/1799/1799391.png" alt="" width="20px">
        <img src="https://www.freeiconspng.com/thumbs/edit-icon-png/edit-new-icon-22.png" alt="" width="20px">
        </div>
        </div>
        </div>`
    })
